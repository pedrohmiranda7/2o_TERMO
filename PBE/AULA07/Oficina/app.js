...
const tempoUso = entrada.questionInt("Meses desde o ultmo conserto: ");

const statusGarantia = oficina.verificarGarantia(tempoUso);
const total = oficina.calcularOrcamento(peca, horas);

const desconto = oficina.totalComDesconto(total)

//Relatorio Final
console.log("\n--- RELATORIO DE SERVICO ---");
console.log(`Orcamento: R$ ${total.toFixed(2)}`);
console.log(`Orcamento com desconto (5%): R$ ${desconto.toFixed(2)}`);
